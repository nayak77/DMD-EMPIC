...
function J = customcolormap_preset(preset_name)
    switch(preset_name)
        ...
        case 'red-yellow-blue2'
            J = customcolormap(linspace(0,1,7), {'#f66e44','#faac5d','#ffdf93','#ffffbd','#def4f9','#abd9e9','#73add2'});            
        ...
        case 'paleblue-blue'
            J = customcolormap(linspace(0,1,5), {'#d5e2f0','#93c5dc','#4295c1','#2265ad','#062e61'});            
        case 'red-white'
            J = customcolormap(linspace(0,1,6), {'#68011d','#b5172f','#d75f4e','#f7a580','#fedbc9','#f9f9f9'});            
        ...
        case 'orange-white'
            J = customcolormap(linspace(0,1,6), {'#7f3c0a','#b35807','#e28212','#f9b967','#ffe0b2','#f9f9f9'});            
